...
# with command line options: -s RAW2DIGI,L1Reco,RECO --mc --conditions auto:phase1_2017_realistic --pileup=NoPileUp -n 10 --no_exec
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RAW2DIGI_L1Reco_RECO.root'),
