...
# with command line options: 2ppRaw2Reco.py --data --conditions 80X_dataRun2_Prompt_v6 --era Run2_25ns --step RAW2DIGI,L1Reco,RECO --datatier RECO --eventcontent RECO -n 100 --no_exec --filein root://xrootd.unl.edu//store/express/Run2016A/ExpressPhysics/FEVT/Express-v1/000/271/056/00000/0AE3F2F3-F908-E611-B3A2-02163E014126
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('2pp_Raw2Reco.py nevts:100'),
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('2pp_Raw2Reco.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '80X_dataRun2_Prompt_v6', '')
